        ...
        <div className="container mx-auto px-4">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-600">
              {currentLang === 'uz' && 'Majlislar'}
              {currentLang === 'ru' && 'Заседания'}
              {currentLang === 'en' && 'Meetings'}
            </span>
          </nav>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              <p className="text-gray-600 text-lg">
                {currentLang === 'uz' && 'Hozircha majlislar mavjud emas.'}
                {currentLang === 'ru' && 'На данный момент заседания отсутствуют.'}
                {currentLang === 'en' && 'No meetings available at the moment.'}
              </p>
            </div>
          </div>
        </div>
